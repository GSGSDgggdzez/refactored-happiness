                ...
                <div>
                    <nav className="flex justify-between items-center bg-white text-green-400 px-5 lg:px-10 mt-2">
                        ...
                        <div className="buttons flex justify-end gap-3">
                            <div>
                                <Link href={'/about'} className="border-2 border-green-400 text-green-400 font-bold py-2 px-5 mt-2 rounded-3xl flex items-center gap-2 hover:bg-green-100 hover:border-green-600 hover:text-green-600 transition duration-100 ease-in-out">
                            ...
                            <div>
                                <a href="https://discord.gg/pTckD8kr" target="_blank" rel="noopener noreferrer">
